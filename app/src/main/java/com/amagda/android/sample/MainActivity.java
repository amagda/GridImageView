...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CircularGridImageView) findViewById(R.id.circular_images_count_1)).setImagePaths(imagePaths[0]);
        ((CircularGridImageView) findViewById(R.id.circular_images_count_2)).setImagePaths(Arrays.copyOf(imagePaths, 2));
        ((CircularGridImageView) findViewById(R.id.circular_images_count_3)).setImagePaths(Arrays.copyOf(imagePaths, 3));
        ((CircularGridImageView) findViewById(R.id.circular_images_count_4)).setImagePaths(Arrays.copyOf(imagePaths, 4));
    }
}
